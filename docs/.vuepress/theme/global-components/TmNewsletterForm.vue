<template lang="pug">
  form(action="" data-code="u7o3l7" method="POST" target="_blank" rel="noreferrer noopener").newsletter__form__component__internal
    .newsletter__desc
      .newsletter__desc__h1
        label(for="newsletter-email-input") Get Keep Network updates
      .newsletter__desc__p You’ll be notified with Keep updates, news and announcements.
    .newsletter__input
